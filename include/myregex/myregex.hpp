...
//         /// @brief Genera un basic_nfa basado en una losta de cadenas de caracteres que representen las expresiones regulares (Nota: Esta funcion es para usarla junto a los argumentos de la funcion main)
//         /// @param list vector de cadenas de caracteres
//         /// @return Devuelve el nfa resultante
//         static basic_nfa<CharT> build_nfa(const std::vector<std::pair<size_t, std::__cxx11::basic_string<CharT>>> &list);
...
//             {
//                 allocator = myregex::basic_builder<CharT>::build_nfa(list);
//             }
//             else if constexpr (std::is_same_v<AllocatorRegexT, myregex::basic_dfa<CharT>>)
//             {
//                 basic_nfa<CharT> nfa = myregex::basic_builder<CharT>::build_nfa(list);
//                 allocator = myregex::basic_builder<CharT>::convert_nfa_to_dfa(nfa);
//             }
//             else
//             {
//                 basic_nfa<CharT> nfa = myregex::basic_builder<CharT>::build_nfa(list);
//                 allocator = myregex::basic_builder<CharT>::convert_dfa_to_table(myregex::basic_builder<CharT>::convert_nfa_to_dfa(nfa));
//             }
//         }
//         /// @brief Constructor por defecto
//         /// @param list
//         basic_regex(const std::vector<std::pair<size_t, std::__cxx11::basic_string<CharT>>> &list)
//         {
//             if constexpr (std::is_same_v<AllocatorRegexT, myregex::basic_nfa<CharT>>)
//             {
//                 allocator = myregex::basic_builder<CharT>::build_nfa(list);
...
//         inline static myregex::caption<CharT> match(const std::__cxx11::basic_string<CharT> &str, const AllocatorRegexT &allocator_regex)
//         {
//             basic_string_range<CharT> range = str;
//             return myregex::basic_regex<CharT, AllocatorRegexT>::template match<option>(range, allocator_regex);
//         }
//         // template <myregex::constants::match_options option>
//         // inline static myregex::caption<CharT> &&_M_match(const std::__cxx11::basic_string<CharT> &str, const AllocatorRegexT &allocator_regex) { return std::move(myregex::basic_regex<CharT>::template match<option>(str, allocator_regex)); }
//         template <myregex::constants::match_options option>
//         static myregex::caption<CharT> match(basic_string_range<CharT> &range, const AllocatorRegexT &allocator_regex);
//         // template <myregex::constants::match_options option>
//         // inline static myregex::caption<CharT> &&_M_match(basic_string_range<CharT> &range, const AllocatorRegexT &allocator_regex) { return std::move(myregex::basic_regex<CharT>::template match<option>(range, allocator_regex)); }
...
//         template <myregex::constants::match_options option>
//         inline myregex::caption<CharT> match(const std::__cxx11::basic_string<CharT> &str) const { return myregex::basic_regex<CharT, AllocatorRegexT>::template match<option>(str, allocator); }
//         /// @brief Esta funcion capta o valida segun el parametro S las cadenas de caracteres dentro del range
//         /// @tparam S Determina la operacion de la funcion
//         /// @param str rango de caracteres de una cadena (para lexers)
//         /// @return Devuelve el iterador al final de la cadena captada o nullptr si hay error junto al identificador de estado de aceptacion
//         template <myregex::constants::match_options option>
//         inline myregex::caption<CharT> match(basic_string_range<CharT> &range) const { return myregex::basic_regex<CharT, AllocatorRegexT>::template match<option>(range, allocator); }
...
//     /////////////////////////////////////////////////////////////////////
//     /////////////////////////////////////////////////////////////////////
//     using CompatibleBuild = myregex::basic_builder<char>;
//     using build = myregex::basic_builder<char>;
//     /////////////////////////////////////////////////////////////////////
//     using UnicodeBuild = myregex::basic_builder<wchar_t>;
//     using wbuild = myregex::basic_builder<wchar_t>;

//     template <typename CharT>
//     CharT basic_builder<CharT>::_S_parser_code_caracter_hexunicode(basic_string_range<CharT> &range, const unsigned char _S)
//     {
//         CharT result;
...
//     template <typename CharT>
//     CharT basic_builder<CharT>::_S_parser_code_caracter_octal(basic_string_range<CharT> &range)
//     {
//         char result;
//         for (char i = 0; i < 3; i++)
//         {
...
//     template <typename CharT>
//     CharT basic_builder<CharT>::_S_parser_code_caracter(basic_string_range<CharT> &range)
//     {
//         CharT c;
//         if (range.peak() >= range.end())
//             throw myregex::regex_error("end termination for regular expresion", range.position(range.end(), -1ULL), range, 0);
...
//         case CharT('x'):
//             range.next();
//             return basic_builder<CharT>::_S_parser_code_caracter_hexunicode(range, 2);
//             break;
//         case CharT('u'):
//             range.next();
//             return basic_builder<CharT>::_S_parser_code_caracter_hexunicode(range, 4);
//             break;
//         case CharT('U'):
//             range.next();
//             return basic_builder<CharT>::_S_parser_code_caracter_hexunicode(range, 8);
//             break;
//         default:
//             if ('0' <= c && c <= '7')
//                 return basic_builder<CharT>::_S_parser_code_caracter_octal(range);
//             range.next();
//             return c;
//             break;
//         }
...
//     template <typename CharT>
//     typename basic_builder<CharT>::_M_range_cualifiquer basic_builder<CharT>::_S_parser_cualifiquer_range(basic_string_range<CharT> &range)
//     {
//         size_t n1 = 0;    // minimo
//         size_t n2 = 0;    // maximo
...
//     template <typename CharT>
//     void basic_builder<CharT>::_S_parser_cualifiquer(basic_string_range<CharT> &range, basic_nfa<CharT> &nfa, const basic_builder<CharT>::_M_begin_transitions &_T_qAtr, bool isGroup)
//     {
//         CharT c = 0;
...
//         {
//             range.next();
//             _M_range_cualifiquer cualifiquer_range = basic_builder<CharT>::_S_parser_cualifiquer_range(range);
//             range.next();
//             if (isGroup)
//             {
...
//     template <typename CharT>
//     typename basic_builder<CharT>::_M_begin_transitions basic_builder<CharT>::_S_parser_nfa_parser_class_expresions(basic_string_range<CharT> &range, basic_nfa<CharT> &nfa)
//     {
...
//                 a = basic_builder<CharT>::_S_parser_code_caracter(range); // Ejecutar caracteres de escape
...
//                 range.next();
//                 if (b == CharT('\\'))
//                     b = basic_builder<CharT>::_S_parser_code_caracter(range);
//                 if (b <= a)
...
//                     transitions.push_back(myregex::basic_builder<CharT>::_S_transition(i));
...
//     template <typename CharT>
//     size_t basic_builder<CharT>::_S_build_nfa_parser_regular_expresions_basic(basic_string_range<CharT> &range, basic_nfa<CharT> &nfa, bool isGroup, size_t id)
//     {
//         // Dado el rango de caracteres
//         while (range.peak() < range.end())
//         {
//             // Obtenemos el caracter actual
//             basic_builder<CharT>::_M_begin_transitions _T_qAtr;
//             CharT c = *range.peak();
...
//                 _T_qAtr = basic_builder<CharT>::_S_build_nfa_parser_or_expresions(range, nfa, true, id);
...
//                 basic_builder<CharT>::_S_parser_cualifiquer(range, nfa, _T_qAtr, true);
//                 break;
//             }
//             case CharT('['):
//             {
//                 // Genera un estado para clases de caracteres
//                 _T_qAtr = basic_builder<CharT>::_S_parser_nfa_parser_class_expresions(range, nfa);
//                 // Si no termina en la posicion correcta, error
//                 if (range.peak() >= range.end())
//                     throw myregex::regex_error("end termination for regular expresion", range.position(range.end(), -1ULL), range, 0);
//                 if (*range.peak() != CharT(']'))
...
//                 range.next();
//                 // Y agregamos su respectivo cualificador
//                 basic_builder<CharT>::_S_parser_cualifiquer(range, nfa, _T_qAtr, false);
//                 break;
//             }
//             case CharT('^'):
//             {
...
//             case CharT('\\'):
//                 c = basic_builder<CharT>::_S_parser_code_caracter(range);
//             default:
//             {
...
//                 nfa.Q_nfa.push_back({});
//                 // Y agregamos su respectivo cualificador
//                 basic_builder<CharT>::_S_parser_cualifiquer(range, nfa, {qA, {myregex::basic_builder<CharT>::_S_transition(c)}}, false);
//                 break;
//             }
//             }
//         }
...
//     template <typename CharT>
//     typename basic_builder<CharT>::_M_begin_transitions basic_builder<CharT>::_S_build_nfa_parser_or_expresions(basic_string_range<CharT> &range, basic_nfa<CharT> &nfa, bool isGroup, size_t id)
//     {
...
//             throw myregex::regex_error("end termination for regular expresion", range.position(range.end(), -1ULL), range, 0);
//         ends.push_back(basic_builder<CharT>::_S_build_nfa_parser_regular_expresions_basic(range, nfa, isGroup, id));
...
//     template <typename CharT>
//     typename myregex::basic_dfa<CharT>::States basic_builder<CharT>::_S_elipson_cloursers(typename basic_dfa<CharT>::States states, const basic_nfa<CharT> &nfa)
//     {
...
//     template <typename CharT>
//     typename myregex::basic_dfa<CharT>::States basic_builder<CharT>::_S_move(typename basic_dfa<CharT>::States states, CharT a, const basic_nfa<CharT> &nfa)
//     {
...
//     template <typename CharT>
//     myregex::basic_dfa<CharT> basic_builder<CharT>::convert_nfa_to_dfa(const basic_nfa<CharT> &nfa)
//     {
//         basic_dfa<CharT> dfa = basic_dfa<CharT>();
//         typename basic_dfa<CharT>::States q0 = basic_builder<CharT>::_S_elipson_cloursers({0}, nfa);
...
//             {
//                 typename basic_dfa<CharT>::States newindex = basic_builder<CharT>::_S_move_elipson_cloursers(index, caraceter, nfa);
//                 if (newindex.empty())
//                     continue;
...
//     template <typename CharT>
//     myregex::basic_table<CharT> basic_builder<CharT>::convert_dfa_to_table(const basic_dfa<CharT> &dfa)
//     {
...
// #else
//         size_table = dfa.Q_dfa.size();
// #endif
//         basic_table<CharT> table {size_table, dfa.F_dfa};
...
//     template <typename CharT>
//     myregex::basic_nfa<CharT> basic_builder<CharT>::build_nfa(const std::__cxx11::basic_string<CharT> &str)
//     {
//         basic_string_range<CharT> range = str;
//         basic_nfa<CharT> nfa;
//         nfa.begin_Q_nfa.push_back(basic_builder<CharT>::_S_build_nfa_parser_or_expresions(range, nfa, false, 0).first);
//         return nfa;
//     }

//     template <typename CharT>
//     myregex::basic_nfa<CharT> basic_builder<CharT>::build_nfa(const std::initializer_list<std::pair<size_t, std::__cxx11::basic_string<CharT>>> &list)
//     {
//         basic_nfa<CharT> nfa;
//         nfa.Q_nfa.push_back({});
...
//             nfa.Q_transitions[{0, -1ULL}].push_back(basic_builder<CharT>::_S_build_nfa_parser_or_expresions(range, nfa, false, expresion.first).first);
//         }
//         return nfa;
//     }

//     template <typename CharT>
//     myregex::basic_nfa<CharT> basic_builder<CharT>::build_nfa(const std::vector<std::pair<size_t, std::__cxx11::basic_string<CharT>>> &list)
//     {
//         basic_nfa<CharT> nfa;
//         nfa.Q_nfa.push_back({});
//         nfa.begin_Q_nfa.push_back(0);
...
// #if TESTCODE
//     template <typename CharT>
//     basic_nfa<CharT> basic_builder<CharT>::build_nfa(const CharT *argv[], size_t size)
//     {
//         basic_nfa<CharT> nfa;
...
//             nfa.Q_transitions[{0, -1ULL}].push_back(basic_builder<CharT>::_S_build_nfa_parser_or_expresions(range, nfa, false).first);
//         }
//         return nfa;
//     }
// #endif
...
//         {
//             typename myregex::basic_dfa<CharT>::States status = myregex::basic_builder<CharT>::_S_elipson_cloursers({0}, allocator_regex);
//             while (range.peak() < range.end())
//             {
//                 CharT letter = *range.peak();
//                 status = myregex::basic_builder<CharT>::_S_move_elipson_cloursers(status, letter);
//                 if (status.empty())
//                     break;
//                 range.next();
//             }
...
//     template <typename CharT, typename AllocatorRegexT>
//     template <myregex::constants::match_options option>
//     myregex::caption<CharT> basic_regex<CharT, AllocatorRegexT>::match(basic_string_range<CharT> &range, const AllocatorRegexT &allocator_regex)
//     {
...
//                 size_t __id = -1ULL;
//                 CharT letter = *range.peak();
//                 status = myregex::basic_builder<CharT>::_S_move_elipson_cloursers(status, letter, allocator_regex);
//                 if (status.empty())
//                     break;
