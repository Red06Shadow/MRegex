...
class basic_iterator_string_range
{
public:// struts
...
public://Funtions
    basic_iterator_string_range(const std::__cxx11::basic_string<CharT> &str) : __begin(str.begin()), __iterator(__begin), __end(str.end()) {}
    basic_iterator_string_range(const CharT *begin, size_t size) : __begin(begin), __iterator(begin), __end(begin + size) {}
